  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100">
      <div className="max-w-7xl mx-auto px-4 py-12">
        <button onClick={handleBack} className="flex items-center text-blue-600 mb-6 hover:text-blue-700">
          <ChevronRight className="w-5 h-5 transform rotate-180" />
          <span>{selectedCourse ? 'Back to Course' : 'Back to Dashboard'}</span>
        </button>
        ...
        <div className="bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-xl p-6 text-center">
          ...
          <p className="mb-4">Ready to learn more?</p>
          <button onClick={handleBack} className="bg-white text-blue-600 px-6 py-2 rounded-lg font-semibold hover:bg-gray-100 transition">
            {selectedCourse ? 'Back to Course' : 'Back to Dashboard'}
          </button>
        </div>
      </div>
    </div>
